...
[{foreach from=$mylist item=listitem}]
    ...
    <tr class="datarow" id="row.[{$_cnt}]">
        [{block name="admin_country_list_item"}]
            ...
            [{ /if}]
            <td valign="top" class="[{ $listclass}][{ if $listitem->oxcountry__oxactive->value == 1}] active[{/if}]" height="15"><div class="listitemfloating">&nbsp;<a href="Javascript:top.oxid.admin.editThis('[{ $listitem->oxcountry__oxid->value}]');" class="openinnewwin [{ $listclass}]">
             &nbsp;
            </a></div></td>
            <td valign="top" class="[{ $listclass}]" height="15"><div class="listitemfloating"><a href="#" class="openinnewwin [{ $listclass}]" rel="[{ $listitem->oxcountry__oxid->value}],[{ $listitem->oxcountry__oxtitle->value }]">[{ $listitem->oxcountry__oxtitle->value }]</a></div></td>
            <td valign="top" class="[{ $listclass}]" height="15"><div class="listitemfloating"><a href="#" class="openinnewwin [{ $listclass}]" rel="[{ $listitem->oxcountry__oxid->value}],[{ $listitem->oxcountry__oxtitle->value }]">[{ $listitem->oxcountry__oxshortdesc->value }]</a></div></td>
            <td valign="top" class="[{ $listclass}]" height="15"><div class="listitemfloating"><a href="#" class="openinnewwin [{ $listclass}]" rel="[{ $listitem->oxcountry__oxid->value}],[{ $listitem->oxcountry__oxtitle->value }]">[{ $listitem->oxcountry__oxisoalpha3->value }]</a></div></td>
